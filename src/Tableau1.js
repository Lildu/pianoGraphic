...
class Tableau1 extends Phaser.Scene{
    ...
    create(){
        ...
        /**   création fusé   */
        this.fuse1=this.add.sprite(-500,Math.random()*100,'fuse').setOrigin(0,0);
        this.fuse1.setVisible(false)
        this.fuse1.scale=0.1;
        this.fuse1.alpha=0.95;
        this.fuse1.angle=0;
        this.tweens.add({
            targets: this.fuse1,
            x: 3000,
