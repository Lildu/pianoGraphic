...
class Tableau1 extends Phaser.Scene{
    ...
    create(){
        ...
        let zombie=this.add.image(1200,250, 'z5').setOrigin(0,0);
        this.groundContainer.add(zombie);

        let zombie2=this.add.image(1600,180, 'z8').setOrigin(0,0);
        this.groundContainer.add(zombie2);

        let zombie3=this.add.image(500,200, 'z13').setOrigin(0,0);
        this.groundContainer.add(zombie3);

        let zombie4=this.add.image(900,250, 'z6').setOrigin(0,0);
        this.groundContainer.add(zombie4);
